...
class SealedDES {
	...
	public SealedObject encrypt(String plainstr) {
		try {
			...
			System.out.println("Failed to encrypt message. " + plainstr + ". Exception: " + e.toString() + ". Message: "
					+ e.getMessage());
		}
		return null;
	}
	...
	public void setKey(long theKey) {
		try {
			...
			System.out.println(
					"Failed to assign key" + theKey + ". Exception: " + e.toString() + ". Message: " + e.getMessage());
		}
	}
}